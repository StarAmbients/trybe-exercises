// O Javascript permite que a gente crie, leia e delete cookie através da propriedade document.cookie . Para criar um cookie, você só precisa atribuir à propriedade document.cookie uma string contendo o nome e o valor do que se pretende armazenar:
...
document.cookie =
  "email=isabella@email.com; expires=Thu, 17 Dec 2020 12:00:00 UTC";
...
document.cookie =
  "email=isabella@email.com; expires=Thu, 17 Dec 2020 12:00:00 UTC; path=/";
...
document.cookie =
  "email=cleyton@email.com; expires=Thu, 17 Dec 2020 12:00:00 UTC";
...
// DSR: esbarrei com esse problema do SameSite... ver: https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Set-Cookie/SameSite
// DSR: soluca: somente executar estes comandos no Console do Brwoser